                ...
                {reportSections.map((section) => (
                  ...
                  >
                    ...
                    <CardContent className="text-lg leading-relaxed text-slate-100">
                      <div className="prose prose-invert max-w-none prose-p:mb-8 prose-p:text-lg prose-p:leading-relaxed">
                        <ReactMarkdown
                          remarkPlugins={[remarkGfm]}
                          components={{
                            p: ({ children }) => <p className="mb-8 leading-relaxed last:mb-0">{children}</p>,
                            table: ({ children }) => (
